...
class CategoryViewTestClass(TestCase):
    ...
    def test_view_get_all_categories_200(self):
    ...
    def test_view_get_category_error_with_unknow_param_404(self):
    ...
    def test_view_get_category_with_content(self):
    ...
    def test_view_create_category_201(self):
    ...
    def test_view_create_existing_category_400(self):
