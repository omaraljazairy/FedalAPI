...
class VerbViewTestClass(TestCase):
    """Verblist view tests."""
    ...
    def setUpClass(cls):
        ...
        cls.api_url = 'http://127.0.0.1:8002/spanglish/verb/'
        cls.api_url2 = 'http://127.0.0.1:8002/spanglish/verbs/'

        # create permissions
        # first get the contenttype of the model
        content_type = ContentType.objects.get_for_model(Verb)
        ...
        change_permission, created = Permission.objects.get_or_create(
            codename='change_verb',
            name='Can change verb',
            content_type=content_type
        )
        delete_permission, created = Permission.objects.get_or_create(
            codename='delete_verb',
            name='Can delete verb',
            content_type=content_type
        )
    ...
    def test_view_get_all_verbs_200(self):
    ...
    def test_view_get_verb_error_with_unknow_param_404(self):
    ...
    def test_view_get_verb_with_content(self):
        """test the get request to the api to get verb id 1.
    ...
    def test_view_create_verb_201(self):
        """post request to create a new verb, expect to get back statuscode 201"""
    ...
    def test_view_create_existing_verb_400(self):
        """post an existing verb"""
        ...
        # self.assertEquals({'verb': ['verb with this verb already exists.']}, content)


    def test_view_put_verb_200(self):
        """update a verb by calling the patch action. expects response 200"""

        uri = f'{self.api_url}1/'
        data = {'tense': 'simple past'}
    ...
    def test_view_delete_verb_204(self):
        """delete a verb and expect 204"""
