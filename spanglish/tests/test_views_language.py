...
class CategoryViewTestClass(TestCase):
    ...
    def test_view_get_all_languages_200(self):
    ...
    def test_view_get_language_error_with_unknow_param_404(self):
    ...
    def test_view_get_language_with_content(self):
        """test the get request to the api to get language id 1.
        ...
        expected_content = {
            ...
            'name': 'English',
            'code': 'en', 
            'created': '2020-03-15 14:35:51+0100'
        }
    ...
    def test_view_create_language_201(self):
        """post request to create a new language, expect to get back
    ...
    def test_view_create_existing_language_400(self):
        ...
        expected_err = { 
            'name': ['language with this name already exists.'],
            'code': ['language with this code already exists.']
        }
        ...
        self.assertEquals(expected_err, content)
